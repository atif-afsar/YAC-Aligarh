...
export const instituteKnowledge = {
  ...
  courses: [
    ...
    },
    {
      ...
      summary:
        "BA & BA FL entrances for AMU & JMI 2027-28. Live classes, PYQs, mocks, and mentorship. ₹14,999 (was ₹19,999).",
      features: [
        "AMU & JMI pattern focus",
        "Live + recorded classes",
        "Weekly mocks & PYQ analysis",
    ...
    },
    {
      ...
      category: "Entrance (UG)",
      summary:
        "B.Com & BBA entrances for AMU & JMI. Complete syllabus, test series, and doubt support. ₹14,999 (was ₹19,999).",
      features: [
        "B.Com & BBA combined prep",
        "Live classes & recorded lectures",
        "Mock tests & PYQ discussion",
    ...
    },
    {
      ...
      summary:
        "AMU B.A.LL.B Entrance 2027-28 — theory, MCQs, sectional & full-length tests. ₹14,999 (was ₹19,999). Live on App.",
      features: [
        "Complete syllabus coverage",
        "Live & recorded classes",
        "Sectional & full mocks",
        "Valid till AMU Entrance 2027-28",
      ],
    },
    {
      id: "entrance-mba",
      ...
      summary:
        "AMU MBA Entrance 2027-28 — QA, reasoning, GK, mocks, and interview guidance. ₹14,999 (was ₹19,999).",
      features: [
        "AMU MBA pattern prep",
        "PYQ analysis & weekly mocks",
